...
const PolicyReturn = resolve => require(['../views/PolicyReturn.vue'], resolve);
const PolicyShipping = resolve => require(['../views/PolicyShipping.vue'], resolve);
...
var routerMaps = [
    ...
    { name: 'PolicyReturn', path: '/PolicyReturn', component: PolicyReturn, meta: { name: 'PolicyReturn' } },
    { name: 'PolicyShipping', path: '/PolicyShipping', component: PolicyShipping, meta: { name: 'PolicyShipping' } },
